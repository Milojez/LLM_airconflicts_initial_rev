# This is the script where all prompts used for test are defined. This means specific level of difficulties (case 1,2,3) and for conflict_reasoning experiment and heading_change experiment
import pyproj
...
#a funcgtion used later in gen_prompt_lvl_head_exp
...
#Based on the resulted reasoning this prompt asks for generating the JSON file summarising the reasoning for the decision
